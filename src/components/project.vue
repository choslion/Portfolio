...
<<<<<<< HEAD
        ...
        url: 'https://kibuttzkorea-choslion.koyeb.app/',
...
<<<<<<< HEAD
        ...
        feeling: '팀프로젝트를 하며 사람이 서로 소통하며 작업하는것 , 그 과정 속에서 긍정적인 생각과 태도가 얼마나 중요한 일인지 알게 되었습니다.',
        contribution: '33.33%',
        mainFunc: '회원가입, 로그인, 게시글 작성, 정보전달',
        url: 'https://seoultakju-choslion.koyeb.app/',
        github: 'https://github.com/choslion/seoulTakju-personal',
        figma: 'https://i.esdrop.com/d/f/BhioNGHPJG/GzsXzPjkht.png',
        useSkills: 'HTML, CSS, JavaScript, MySQL, Node.js',
=======
          "첫 팀프로젝트 입니다. 팀의 조장을 맡아 여러 사람의 의견이 잘 어우러지게 사이트를 제작하였습니다. 또한 처음으로 git을 이용한 버전관리를 경험 하였고, 제가 맡은 부분은 메인페이지, 카카오맵 Api를 받아 지도 가져오기 그리고 MySQL을 node.js 와 연동해 DB의 정보를 가져올 수 있는 게시판을 구현하였습니다.",
        feeling: "팀프로젝트를 하며 사람이 서로 소통하며 작업하는것 , 그 과정 속에서 긍정적인 생각과 태도가 얼마나 중요한 일인지 알게 되었습니다.",
        contribution: "33.33%",
        mainFunc: "회원가입, 로그인, 게시글 작성, 정보전달",
        url: "https://seoultakju.herokuapp.com/",
        github: "https://github.com/choslion/seoulTakju-personal",
        figma: "https://i.esdrop.com/d/f/BhioNGHPJG/GzsXzPjkht.png",
        useSkills: "HTML, CSS, JavaScript, MySQL, Node.js",
>>>>>>> 268d7063b9e59b9199a2c05215687ce114b1fb36
      },
      {
        ...
        feeling:
          "처음 알게되는 개념(다양한 npm , ES6 문법 , Node.js문법) 이 많아서 흐름을 이해하려고 최대한 노력했던 페이지이고 ejs , pug 등 템플릿엔진들끼리 문법과 구조가 비슷하다고 생각하였습니다. 그리고 웹페이지에서 백엔드 개발자가 하는 처리에 관해 알게 되어서 협업 할 때 도움이 될 것 같다고 생각했습니다.",
        contribution: "100%",
